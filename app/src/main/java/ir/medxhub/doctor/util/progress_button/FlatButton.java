package ir.medxhub.doctor.util.progress_button;
...
public class FlatButton extends Button {
    ...
    private LayerDrawable createNormalDrawable(TypedArray attr) {
        ...
        int blueDark = getColor(R.color.green_pressed);
        ...
        int blueNormal = getColor(R.color.green_normal);
    ...
    /**
     * Set the DoctorView's background. Masks the API changes made in Jelly Bean.
     *
     * @param drawable
     */
