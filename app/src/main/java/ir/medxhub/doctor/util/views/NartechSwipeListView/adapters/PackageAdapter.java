package ir.medxhub.doctor.util.views.NartechSwipeListView.adapters;///*
...
//import android.view.DoctorView;
...
//
//    @Override
//    public DoctorView getView(final int position, DoctorView convertView, ViewGroup parent) {
//        final PackageItem item = getItem(position);
//        ViewHolder holder;
//        if (convertView == null) {
//            LayoutInflater li = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//            convertView = li.inflate(R.layout.listitem_patient2, parent, false);
...
//            holder.bAction1 = (Button) convertView.findViewById(R.id.example_row1_b_action_1);
//            holder.bAction2 = (Button) convertView.findViewById(R.id.example_row1_b_action_2);
//            holder.bAction3 = (Button) convertView.findViewById(R.id.example_row1_b_action_3);
...
//
//
//        holder.bAction1.setOnClickListener(new DoctorView.OnClickListener() {
//            @Override
//            public void onClick(DoctorView v) {
//                Intent intent = context.getPackageManager().getLaunchIntentForPackage(item.getPackageName());
//                if (intent != null) {
//                    context.startActivity(intent);
//                } else {
//                    Toast.makeText(context,
//                            "cantOpen", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
//
//        holder.bAction2.setOnClickListener(new DoctorView.OnClickListener() {
//            @Override
//            public void onClick(DoctorView v) {
...
//        });
//
//        holder.bAction3.setOnClickListener(new DoctorView.OnClickListener() {
//            @Override
//            public void onClick(DoctorView v) {
