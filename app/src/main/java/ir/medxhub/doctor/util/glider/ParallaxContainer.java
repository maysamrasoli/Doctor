        ...
        for (View view : parallaxViews) {
            ...
            if ((pageIndex == tag.index - 1
                ...
                if (Build.VERSION.SDK_INT > 13) {
                    ...
                    // slide in from right
                    ViewHelper.setTranslationX(view, (containerWidth - offsetPixels) * tag.xIn);

                    // slide in from top
                    ViewHelper.setTranslationY(view, 0 - (containerWidth - offsetPixels) * tag.yIn);

                    // fade in
                    ViewHelper.setAlpha(view, 1.0f - (containerWidth - offsetPixels) * tag.alphaIn / containerWidth);
                }
                ...
                if (Build.VERSION.SDK_INT > 13) {
                    ...
                    // slide out to left
                    ViewHelper.setTranslationX(view, 0 - offsetPixels * tag.xOut);

                    // slide out to top
                    ViewHelper.setTranslationY(view, 0 - offsetPixels * tag.yOut);

                    // fade out
                    ViewHelper.setAlpha(view, 1.0f - offsetPixels * tag.alphaOut / containerWidth);
                }
