...
package ir.persiandatepicker.app.date;
...
import ir.persiandatepicker.app.HapticFeedbackController;
import ir.persiandatepicker.app.R;
import ir.persiandatepicker.app.TypefaceHelper;
import ir.persiandatepicker.app.Utils;
import ir.persiandatepicker.app.utils.LanguageUtils;
import ir.persiandatepicker.app.utils.PersianCalendar;
...
public class DatePickerDialog extends DialogFragment implements
    ...
    private int mWeekStart = PersianCalendar.SATURDAY; // TODO : HERE
    ...
    private void setCurrentView(final int viewIndex) {
        ...
        switch (viewIndex) {
            case MONTH_AND_DAY_VIEW:
                ...
                String dayString = LanguageUtils.getPersianNumbers(mPersianCalendar.getPersianLongDate()); // TODO
            ...
            case YEAR_VIEW:
                ...
                mAnimator.setContentDescription(mYearPickerDescription + ": " + LanguageUtils.getPersianNumbers(yearString)); // TODO
    ...
    private void updateDisplay(boolean announce) {
        ...
        mSelectedMonthTextView.setText(LanguageUtils.getPersianNumbers(mPersianCalendar.getPersianMonthName()));
        mSelectedDayTextView.setText(LanguageUtils.getPersianNumbers(String.valueOf(mPersianCalendar.getPersianDay())));
        mYearView.setText(LanguageUtils.getPersianNumbers(String.valueOf(mPersianCalendar.getPersianYear())));
        ...
        mMonthAndDayView.setContentDescription(monthAndDayText); // TODO

        if (announce) {
            String fullDateText = LanguageUtils.getPersianNumbers(mPersianCalendar.getPersianLongDate());
            Utils.tryAccessibilityAnnounce(mAnimator, fullDateText);  // TODO
        }
    }
